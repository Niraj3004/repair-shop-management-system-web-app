  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500">Provide details about your device and the issue you're facing.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Device Details</CardTitle>
          <CardDescription>We need this information to prepare the right parts for your repair.</CardDescription>
        </CardHeader>
        <CardContent>
